...
(async () => {
	// constants
	const PAGE_URL = `https://twitter.com/search?q=(%23NFLX)%20until%3A2018-01-07%20since%3A2018-01-01&src=typed_query&f=top`;
	const TWEET_LIMIT = 31;
	...
	while (canMove && i < TWEET_LIMIT) {
		...
		const data = await page.evaluate(() => {
			...
			const date = tweet.querySelector("time");
